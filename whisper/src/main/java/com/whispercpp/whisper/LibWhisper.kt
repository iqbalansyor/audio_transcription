...
private class WhisperLib {
    companion object {
        init {
            ...
            // Skip optimized libraries on emulator - FP16 emulation is unreliable
            val isEmulator = isEmulator()
            if (isEmulator) {
                Log.d(LOG_TAG, "Running on emulator, using default library")
            }

            if (!isEmulator && isArmEabiV7a()) {
            ...
            } else if (!isEmulator && isArmEabiV8a()) {
